...
$this->load->view('payment', $data);
   ...
   // $paymentMethod = $this->input->post('paymentMethod');
    ...
    $orderData = [
        ...
        'order_status'    => 'Pending',  // Adjust as needed (e.g., 'Pending', etc.)
        'order_date'      => date('Y-m-d H:i:s'),
        'payment_status'  => 'Pending'           // Update based on payment processing results
...
public function update_information() {
    ...
    $cardMobile = $this->input->post('cardMobile');
$cardName   = $this->input->post('cardName');
   ...
   if ($updated) {
        ...
        $orderItems = $this->db->get('order_items')->result();
        ...
        echo json_encode(['status' => false, 'message' => 'Failed to update order']);
    }
